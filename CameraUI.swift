...
struct ContentView: View {
    ...
    /// chậm là đèn + mốc fps. Lối vào Cài đặt đã dời xuống `settingsButton`
    /// ở hàng nút chụp, nên thanh trên chỉ còn việc của camera.
    ...
    /// Nút ba chấm ở hàng nút chụp mở thẳng Cài đặt. Không dùng `Menu` ở đây:
    /// người dùng không phải bấm thêm lần thứ hai để chọn mục Cài đặt.
    ...
    /// Hàng nút chụp: nút chụp ở giữa, nút Cài đặt bên phải. Bên trái để trống
    ...
    /// một lượt render.
    ///
    /// `spacing` phải NHỎ hơn khoảng hở thật giữa nút Cài đặt và nút đổi camera
    /// ngay dưới nó, nếu không hai viên kính hoà thành một cục dọc. Khoảng hở
    /// đó = (74 − 52)/2 + `VStack.spacing` = 11 + 12 = 23pt, nên 10 là an toàn.
    ///
